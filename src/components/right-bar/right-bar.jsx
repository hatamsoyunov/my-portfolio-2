...
import { faTelegramPlane, faSkype } from '@fortawesome/free-brands-svg-icons';
    ...
    render() {
        ...
        return (
            <div className="right-bar">
                <div className={`header-layer${this.state.headerLayerIsShow ? ' header-layer--visible' : ''}`} ref={this.headerLayer}></div>
                <button className={`hamburger hamburger--slider${showMenu ? ' is-active' : ''}`} onClick={toggleMenu}>
                ...
                <div
                    ...
                    style={{
                        opacity: showMenu || this.props.location.pathname !== '/' ? '0' : '1',
                    }}
                >
                ...
                <div className="socs">
                    <ul className="socs__list">
                        <li className="socs__item">
                            <a href="skype:hattam.soyunow?chat" className="socs__link" target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={faSkype} />
                            </a>
                        </li>
                        <li className="socs__item">
                            <a href="tg://resolve?domain=hatamsoyunov" className="socs__link" target="_blank" rel="noopener noreferrer">
